...
namespace Blogger.Controllers
{
    public class AdminPanelPostController : Controller
    {
        ...
        {
            var postDetails = db.PostDetails.Include(p => p.CategoryDetail).Include(p => p.User);
        ...
        public ActionResult Create([Bind(Include = "PostId,Title,Post_Content,Create_time,Tages,FeaturedImage,CategoryId,UserId")] PostDetail postDetail)
        {
